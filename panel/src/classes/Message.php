...
class Message {
    ...
    //this function returns:
    //table with all received messages by user,
    //empty table if no messages for this user
    ...
    //this function returns:
    //table with all messages to this order,
    //empty table if no messages for this order
    ...
    //empty table if no messages in the db
