...
if ($isLoggedAdmin) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && ( isset($_POST['yes']) || isset($_POST['no']) )) {
        ...
        if (!empty($_POST['yes'])) {
            ...
            if (User::DeleteUserByAdmin($id)) {
                if (isset($_SESSION['user_id'])) {
                    unset($_SESSION['user_id']);
                }
                header("Location: ../../../../index.php?manageType=userManage");
            } else {
                $switch = 2;
            }
                ...
                <center>    
                    ...
                    if ($switch == 1 || $switch == 2) {
                        ...
                        <form action="../../../../index.php" method="post" role="form">
                            <button type="submit" value="userManage" name="manageType" class="btn btn-success">Back</button>  
                        </form>
                        ...
                        <form action="" method="post" role="form">
                            ...
                            <button type="submit" value="<?php echo $_SESSION['user_id'] ?>" name="yes" class="btn btn-success">Confirm</button>
